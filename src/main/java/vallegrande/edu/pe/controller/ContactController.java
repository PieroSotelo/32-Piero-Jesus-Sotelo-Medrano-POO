...
public class ContactController {
    ...
    public Contact create(String id, String name, String email, String edad, String phone) {
        int edadInt = Integer.parseInt(edad); // convierte el String a int
        Contact c = new Contact(id, name, email, edadInt, phone);
        return repo.save(c);
